...
void withdraw(Checking_Account &accounts, double amount) {
    std::cout << "\n=== Withdrawing from Checking Accounts=======================" << std::endl;
    
        if (accounts.withdraw(amount)) 
            std::cout << "Withdrew " << amount << " from " << accounts << std::endl;
        else
            std::cout << "Failed Withdrawal of " << amount << " from " << accounts << std::endl;
